...
Aura_Shadow_Caster_Poly_Add_Point((sprite_width / 2), 0);
Aura_Shadow_Caster_Poly_Add_Point(sprite_width, sprite_height);
Aura_Shadow_Caster_Poly_Add_Point(sprite_width / 2, sprite_height / 2);
Aura_Shadow_Caster_Poly_Add_Point(0, sprite_height);
Aura_Shadow_Caster_Poly_Add_Point((sprite_width / 2), 0);
